...
```CLI
$ helm install --name stages-dev ./api/helm  --kubeconfig="api/helm/conduction-kubeconfig.yaml" --namespace=dev  --set settings.env=dev,settings.debug=1
$ helm install --name stages-stag ./api/helm --kubeconfig="api/helm/conduction-kubeconfig.yaml" --namespace=stag --set settings.env=stag,settings.debug=0
$ helm install --name stages-prod ./api/helm --kubeconfig="api/helm/conduction-kubeconfig.yaml" --namespace=prod --set settings.env=prod,settings.debug=0
```

Or update if you want to update an existing one
```CLI
$ helm upgrade stages-dev ./api/helm  --kubeconfig="api/helm/conduction-kubeconfig.yaml" --namespace=dev  --set settings.env=dev,settings.debug=1
$ helm upgrade stages-stag ./api/helm --kubeconfig="api/helm/conduction-kubeconfig.yaml" --namespace=stag --set settings.env=stag,settings.debug=0
$ helm upgrade stages-prod ./api/helm --kubeconfig="api/helm/conduction-kubeconfig.yaml" --namespace=prod --set settings.env=prod,settings.debug=0
```

Or del if you want to delete an existing  one
```CLI
$ helm del stages-dev  --purge --kubeconfig="api/helm/conduction-kubeconfig.yaml" 
$ helm del stages-stag --purge --kubeconfig="api/helm/conduction-kubeconfig.yaml" 
$ helm del stages-prod --purge --kubeconfig="api/helm/conduction-kubeconfig.yaml" 
```
